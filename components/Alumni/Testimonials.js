  ...
  const testimonials = [
    {
      ...
      words: "Realizing the role which SSGSA award played in moving towards \
    ...
    },
    {
      ...
      imageUrl: "/members/AbdulHaleemKidwai.jpeg",
      words: "In a world that is becoming increasingly divisive, antagonistic \
    ...
    },
    {
      ...
      words: "Throughout my journey to get an admit in one of the best \
    ...
    },
    {
      ...
      words: "Being a SSGSA awardee and a proud member of the family, I feel \
    ...
    },
    {
      ...
      position: "Postdoctoral Researcher, Vanderbilt University Medical Center, USA",
      imageUrl: "/members/MohammadSaleem.jpg",
      words: "During my application process, SSGSA team helped me in every \
    ...
    },
    {
      ...
      words: "Mentors can make profound positive impacts on the lives of their \
    ...
    },
    {
      ...
      words: "SSGSA makes it easy for a student by not only paying for tests \
        ...
        mentoring landed me into the Master’s program at Purdue University, a \
  ...
  return (
    <div id="Testimonials">
      ...
      {testimonials.map((testimonial, index) => (
        <div
          className="mx-8 sm:mx-16 lg:mx-24 my-8 flex flex-col md:flex-row items-center bg-red-850 rounded-tl-3xl rounded-br-3xl"
          key={index}
        >
          <div
