 ...
 const About = () => {
  return (
    <div className="  text-black w-full lg:mr-4 lg:p-8 p-4">
      <h1 className="  -my-8 bg-blue-850 lg:text-3xl text-2xl mb-10 h-14 text-white text-center font-extrabold py-2 rounded-tl-3xl rounded-br-3xl">Foundation of the Sir Syed Scholar Award</h1>
       <div className=" mx-28 " >
      <p>
      ...
      position in a Master’s or PhD program. These volunteers who mentor students are 
