    ...
    <div className="w-full lg:mr-4">
      ...
      <table className="w-full">
        <tbody>
          ...
          <tr>
            <td className="bg-blue-850 text-white p-2">Interviews</td>
            <td className="border-2 border-gray-300 p-2">To be announced</td>
          </tr>
          <tr>
            <td className="bg-blue-850 text-white p-2">
          ...
          <tr>
            <td className="bg-blue-850 text-white p-2">Orientation</td>
            <td className="border-2 border-gray-300 p-2">To be announced</td>
          </tr>
          <tr>
            <td className="bg-blue-850 text-white p-2">Allotment of Mentors</td>
            <td className="border-2 border-gray-300 p-2">To be announced</td>
          </tr>
          <tr>
            <td className="bg-blue-850 text-white p-2">Start of Term</td>
            <td className="border-2 border-gray-300 p-2">To be announced</td>
          </tr>
        </tbody>
      </table>
