export const awardees = [
  ...
  },
  {
    session: '2022-23',
    awardees: [
      { name: 'Saima Khan Afridi', field: 'Chemistry' },
      { name: 'Mohd Ahmad', field: 'Biotechnology' },
      { name: 'Sobia Ahmed', field: 'Operations Management' },
      { name: 'Asmer Hamid Ali', field: 'Electronics Engineering' },
      { name: 'Abdullah Alvi', field: 'Electrical Engineering' },
      { name: 'Ramsha Anwer', field: 'Biochemistry' },
      { name: 'Sk Md Aquib ', field: 'Applied Geology' },
      { name: 'Mohd Fahad', field: 'Biotechnology' },
      { name: 'Amina Faiz', field: 'Computer Science' },
      { name: 'Ishan Gupta ', field: 'Computer Engineering' },
      { name: 'Md Meraj Khalid', field: 'Chemical Engineering' },
      { name: 'Alisha Khan', field: 'Architecture' },
      { name: 'Mohd Maaz Khan', field: 'Electronics Engineering' },
      { name: 'Dhruv Maheshwari', field: 'Computer Engineering' },
      { name: 'Taqdees Mariam', field: 'Architecture' },
      { name: 'Maryam Nisar', field: 'Biochemistry' },
      { name: 'Abbas Syed Nooruddin', field: 'Electrical Engineering' },
      { name: 'Ahmad Ozair', field: 'Medicine' },
      { name: 'Hera Rashid', field: 'Industrial Chemistry' },
      { name: 'Mohammad Abdullah Sarkar', field: 'Psychology' },
      { name: 'Arsalan Sartaj', field: 'Electrical Engineering' },
      { name: 'Pratiksha Singh', field: 'Business Management' },
      { name: 'Mohd Ubaid', field: 'Civil Engineering' },
      { name: 'Mohd Mohi Uddin', field: 'Physics' },
      { name: 'Raza Haider Zaidi', field: 'Law' },
      { name: 'Mohammad Zain', field: 'Electronics Engineering' },
      { name: 'Mahwish Zaman', field: 'Psychology' },
    ],
  },
]
